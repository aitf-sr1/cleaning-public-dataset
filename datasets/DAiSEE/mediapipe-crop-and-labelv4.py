...
MAIN_OUTPUT_FOLDER = "./output/Cleaning_daisee_binary"
...
def map_label_binary(value: int, column: str) -> int:
            ...
            cropped_data.append(
                {
                    ...
                    "Boredom": map_label_binary(int(row["Boredom"]), "Boredom"),
                    "Engagement": map_label_binary(int(row["Engagement"]), "Engagement"),
                    "Confusion": map_label_binary(int(row["Confusion"]), "Confusion"),
                    "Frustration": map_label_binary(int(row["Frustration"]), "Frustration"),
                }
            )
